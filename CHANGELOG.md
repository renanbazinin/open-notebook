...
### Added
- Arabic (`ar-SA`) interface translations and date formatting, selectable from the language menu, with app-wide document language and RTL direction handling (#1277).

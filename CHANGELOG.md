...
### Added
- Arabic (`ar-SA`) interface translations and Saudi date formatting, selectable from the translated language menu, with app-wide document language and RTL direction handling before hydration and language-switch paint (#1277).

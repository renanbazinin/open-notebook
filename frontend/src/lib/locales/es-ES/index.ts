...
export const esES = {
  ...
  podcasts: {
    ...
    usedByCount_one: "Usado por {{count}} episodio",
    usedByCount_zero: "Usado por {{count}} episodios",
    usedByCount_two: "Usado por {{count}} episodios",
    usedByCount_few: "Usado por {{count}} episodios",
    usedByCount_many: "Usado por {{count}} episodios",

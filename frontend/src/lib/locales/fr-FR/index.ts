...
export const frFR = {
  ...
  podcasts: {
    ...
    usedByCount_one: "Utilisé par {{count}} épisode",
    usedByCount_zero: "Utilisé par {{count}} épisodes",
    usedByCount_two: "Utilisé par {{count}} épisodes",
    usedByCount_few: "Utilisé par {{count}} épisodes",
    usedByCount_many: "Utilisé par {{count}} épisodes",

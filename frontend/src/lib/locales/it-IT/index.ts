...
export const itIT = {
  ...
  podcasts: {
    ...
    usedByCount_one: "Usato da {{count}} episodio",
    usedByCount_zero: "Usato da {{count}} episodi",
    usedByCount_two: "Usato da {{count}} episodi",
    usedByCount_few: "Usato da {{count}} episodi",
    usedByCount_many: "Usato da {{count}} episodi",

...
export const jaJP = {
  ...
  podcasts: {
    ...
    noDescription: "説明なし。",
    usedByCount_one: "{{count}}つのエピソードで使用",
    usedByCount_zero: "{{count}}個のエピソードで使用",
    usedByCount_two: "{{count}}個のエピソードで使用",
    usedByCount_few: "{{count}}個のエピソードで使用",
    usedByCount_many: "{{count}}個のエピソードで使用",

...
export const ptBR = {
  ...
  podcasts: {
    ...
    usedByCount_one: "Usado por {{count}} episódio",
    usedByCount_zero: "Usado por {{count}} episódios",
    usedByCount_two: "Usado por {{count}} episódios",
    usedByCount_few: "Usado por {{count}} episódios",
    usedByCount_many: "Usado por {{count}} episódios",

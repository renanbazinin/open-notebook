...
export const ruRU = {
  ...
  podcasts: {
    ...
    usedByCount_one: "Используется в {{count}} эпизоде",
    usedByCount_zero: "Используется в {{count}} эпизодах",
    usedByCount_two: "Используется в {{count}} эпизодах",
    usedByCount_few: "Используется в {{count}} эпизодах",
    usedByCount_many: "Используется в {{count}} эпизодах",
